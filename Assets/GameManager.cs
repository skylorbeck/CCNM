...
public class GameManager : MonoBehaviour
{
    ...
    public DeckObject deck => battlefield.deck;
    public PlayerBrain runPlayer => battlefield.player;
    public TrackableStats runStats => runPlayer.trackableStats;
    public UIStateObject uiStateObject;
    public EventSystem eventSystem;
    public RunSettings runSettings;
    public PlayerBrain metaPlayer;
    public TrackableStats metaStats => metaPlayer.trackableStats;
